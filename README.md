...
Учебный комплект по дисциплине «Прикладные задачи машинного обучения»: четыре лабораторные работы, четыре презентации по шаблону Финансового университета, модульные Python-примеры и интерактивный сайт.
