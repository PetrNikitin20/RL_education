...
Учебный комплект по дисциплине «Прикладные задачи машинного обучения»: презентация, модульные Python-примеры и единый интерактивный сайт.
...
Веб-демонстрации выполняются полностью в браузере и не требуют сервера. Числа в торговом стенде синтетические и предназначены только для обучения.
